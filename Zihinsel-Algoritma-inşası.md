...
## 8. RFC-First: Standartlar ve Spesifikasyonlar

> **"Kaynak koda değil, kaynağın kaynağına git"**

**Tetikleyici:** `RFC-FIRST`

### Neden RFC ve Standartlar?

Bir teknoloji hakkında "nasıl çalışıyor" sorusunun en kesin cevabı, o teknolojiyi tanımlayan spesifikasyondadır. Blog yazıları yorumdur, RFC ise kanundur.

### RFC-First Ne Zaman Devreye Girer?

| Durum | Örnek | Başvuru |
|-------|-------|---------|
| **Protokol Davranışı** | HTTP status code ne anlama geliyor? | RFC 7231 |
| **Güvenlik Standardı** | JWT nasıl doğrulanır? | RFC 7519 |
| **Veri Formatı** | ISO 8601 tarih formatı nedir? | ISO 8601 |
| **API Tasarımı** | REST doğru mu yapıyorum? | Fielding Dissertation |
| **Email Validasyonu** | Geçerli email formatı nedir? | RFC 5322 |

### Temel Kaynaklar

**RFC ve Internet Standartları:**
- https://datatracker.ietf.org - IETF RFC arama
- https://www.rfc-editor.org - RFC tam metin
- https://httpwg.org/specs/ - HTTP spesifikasyonları

**Web Standartları:**
- https://html.spec.whatwg.org - HTML Living Standard
- https://tc39.es/ecma262/ - ECMAScript (JavaScript) spesifikasyonu
- https://www.w3.org/TR/ - W3C standartları (CSS, DOM, vb.)

**API & Veri Standartları:**
- https://json-schema.org - JSON Schema
- https://spec.openapis.org - OpenAPI (Swagger)
- https://graphql.github.io/graphql-spec/ - GraphQL spesifikasyonu

### Web Geliştirici İçin Kritik RFC'ler

| RFC | Konu | Ne Zaman Bak |
|-----|------|--------------|
| RFC 7231 | HTTP Semantics | Status code kararsızlığı |
| RFC 7519 | JWT | Token implementasyonu |
| RFC 6749 | OAuth 2.0 | Auth flow tasarımı |
| RFC 7807 | Problem Details | API error response |
| RFC 5322 | Email Format | Email validasyonu |
| RFC 3986 | URI Syntax | URL parsing/building |
| RFC 6265 | Cookies | Cookie yönetimi |
| RFC 7617 | Basic Auth | HTTP authentication |
...
├─────────────────────────────────────────────────────────┤
│                                                         │
│  1. Abstract → Ne hakkında?                             │
│                                                         │
│  2. Introduction → Problem nedir?                       │
│                                                         │
│  3. İhtiyacın olan bölüme atla                          │
│     (Table of Contents kullan)                          │
│                                                         │
│  4. MUST, SHOULD, MAY kelimelerine dikkat               │
│     (RFC 2119 - zorunluluk seviyeleri)                  │
│                                                         │
│  5. Examples bölümünü incele                            │
│                                                         │
│  6. Security Considerations → Riskler                   │
│                                                         │
└─────────────────────────────────────────────────────────┘
```

### RFC Terminolojisi (RFC 2119)

| Terim | Anlam |
|-------|-------|
| **MUST** | Kesinlikle uygulanmalı |
| **MUST NOT** | Kesinlikle yapılmamalı |
| **SHOULD** | Güçlü öneri, istisna olabilir |
| **SHOULD NOT** | Güçlü karşı öneri |
| **MAY** | Opsiyonel, tercih meselesi |

### Pratik Örnek: JWT Doğrulama

❌ **Blog'dan öğrenmek:**
> "JWT'yi decode edip kullanıcı bilgilerini alın"

✅ **RFC 7519'dan öğrenmek:**
> "JWT doğrulama MUST şu adımları içermelidir: signature verification, expiration check (exp claim), audience validation (aud claim)..."
...
*Versiyon: 1.1 - RFC-First eklendi*
