    ...
    <>
      ...
      {!isOpen && (
        <button
          ...
          className="fixed bottom-24 right-6 z-[100] w-16 h-16 bg-gradient-to-br from-gold to-amber-600 text-white rounded-full shadow-2xl hover:scale-110 hover:shadow-gold/50 transition-all duration-500 flex items-center justify-center group"
        >
          ...
          <div className="w-full max-w-md h-[600px] bg-white dark:bg-dark-800 rounded-[40px] shadow-2xl border border-gray-200 dark:border-gray-700 flex flex-col pointer-events-auto animate-in slide-in-from-bottom-8 duration-500">
            ...
            <div className="flex items-center justify-between p-6 border-b border-gray-100 dark:border-gray-700">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="font-display text-xl font-bold text-brown-900 dark:text-white">AI Sommelier</h3>
                  <p className="text-xs text-gray-400">Çikolata Danışmanınız</p>
                </div>
              </div>
              <button
                      ...
                      {msg.recommendations.map((productId) => {
                        ...
                        return (
                          <div
                            ...
                            className="flex items-center gap-3 bg-white dark:bg-dark-800 border border-gold/20 rounded-xl p-3 cursor-pointer hover:shadow-lg hover:border-gold/40 transition-all duration-300"
                          >
                            <img
                              src={product.image}
                              alt={product.title}
                ...
                <div className="flex flex-wrap gap-2">
                  {guidingQuestions.slice(0, 3).map((q) => (
                    <button
                      ...
                      className="px-4 py-2 bg-gray-50 dark:bg-dark-900/50 text-xs text-gray-600 dark:text-gray-300 rounded-full hover:bg-gold/10 hover:text-gold transition-all"
                    >
                      {q.text}
                    </button>
                  ))}
            ...
            <div className="p-6 border-t border-gray-100 dark:border-gray-700">
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className="w-12 h-12 bg-gold text-white rounded-full flex items-center justify-center hover:bg-amber-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  <Send size={18} />
                </button>
              </div>
